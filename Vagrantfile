...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ylogosha-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/provectus-it"
  #   chef.validation_client_name = "provectus-it-validator"
  #   chef.validation_key_path = ".chef/provectus-it-validator.pem"
  # end
end
